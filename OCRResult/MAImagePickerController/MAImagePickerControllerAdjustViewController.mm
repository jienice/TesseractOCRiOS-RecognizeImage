...
- (void)viewDidLoad
{
    ...
    [_adjustToolBar setBarTintColor:[UIColor lightGrayColor]];
    
    UIBarButtonItem *cancelButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"close"] target:self action:@selector(popCurrentViewController)];
    cancelButton.accessibilityLabel = @"Return to Camera Viewer";
    
    UIBarButtonItem *undoButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"crop"] target:self action:@selector(resetRectFrame)];
    undoButton.accessibilityLabel = @"Reset Frame";
    
    UIBarButtonItem *confirmButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"confirm"] target:self action:@selector(confirmedImage)];
