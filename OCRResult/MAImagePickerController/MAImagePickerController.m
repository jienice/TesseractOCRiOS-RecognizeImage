...
- (void)viewDidLoad
{
    ...
    if (_sourceType == MAImagePickerControllerSourceTypeCamera && [UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera])
    {
        ...
        [_cameraToolbar setBarTintColor:[UIColor lightGrayColor]];
        
        
        UIBarButtonItem *cancelButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"close"] target:self action:@selector(dismissMAImagePickerController)];
        cancelButton.accessibilityLabel = @"Close Camera Viewer";
        
        _pictureButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"takephoto"] target:self action:@selector(pictureMAIMagePickerController)];
        ...
        {
            _flashButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"flash_open"] target:self action:@selector(toggleFlash)];
        ...
        {
            _flashButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"flash_close"] target:self action:@selector(toggleFlash)];
...
- (void)toggleFlash
{
    if (flashIsOn)
    {
        flashIsOn = NO;
        [_captureManager setFlashOn:NO];
        [_flashButton setImage:[UIImage imageNamed:@"flash_close"]];
        _flashButton.accessibilityLabel = @"Enable Camera Flash";
    ...
    else
    {
        flashIsOn = YES;
        [_captureManager setFlashOn:YES];
        [_flashButton setImage:[UIImage imageNamed:@"flash_open"]];
        _flashButton.accessibilityLabel = @"Disable Camera Flash";
        [self storeFlashSettingWithBool:YES];
    }
}
