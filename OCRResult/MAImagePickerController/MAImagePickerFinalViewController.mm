...
- (void)setupToolbar
{
    ...
    [finishToolBar setBarTintColor:[UIColor lightGrayColor]];
    
    UIBarButtonItem *undoButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"crop"] target:self action:@selector(popCurrentViewController)];
    undoButton.accessibilityLabel = @"Return to Frame Adjustment View";
    
    _rotateButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"rotate"] target:self action:@selector(rotateImage)];
    _rotateButton.accessibilityLabel = @"Rotate Image by 90 Degrees";
    
    UIBarButtonItem *confirmButton = [UIBarButtonItem barButtonItemWithImage:[UIImage imageNamed:@"confirm"] target:self action:@selector(comfirmFinishedImage)];
